                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">info@pharmooworld.com</p>
                      <p className="text-muted-foreground">sales@pharmooworld.com</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        With distribution centers worldwide to serve you better
                      </p>
                    </div>
                  </div>
                </CardContent>
